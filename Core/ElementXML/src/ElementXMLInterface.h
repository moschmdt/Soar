...
// Hard coding the lib here so I don't have to go and update all of the other
projects
 ...
 */
EXPORT bool soarxml_SetTagName(ElementXML_Handle hXML, char* tagName,
                               bool copyName);
 ...
 */
EXPORT ElementXML_Handle const soarxml_GetChild(ElementXML_Handle const hXML,
                                                int index);
 ...
 */
EXPORT bool soarxml_AddAttribute(ElementXML_Handle hXML, char* attributeName,
                                 char* attributeValue, bool copyName,
                                 bool copyValue);
 ...
 */
EXPORT char const* soarxml_GetAttributeName(ElementXML_Handle const hXML,
                                            int index);
 ...
 * @param index  The 0-based index of the attribute to return.
 */
EXPORT char const* soarxml_GetAttributeValue(ElementXML_Handle const hXML,
                                             int index);
 ...
 */
EXPORT void soarxml_SetCharacterData(ElementXML_Handle hXML,
                                     char* characterData, bool copyData);
 ...
 *take ownership of characterData
 */
EXPORT void soarxml_SetBinaryCharacterData(ElementXML_Handle hXML,
                                           char* characterData, int length,
                                           bool copyData);
 ...
 *data should be stored in a CDATA section. By default this value will be false.
 *
 *        This value is ignored if the character data is marked as binary data.
 *
 * @param useCData   true if this element�s character data should be stored in a
 *CDATA section.
 */
 ...
 *DeleteString().
 */
EXPORT char* soarxml_GenerateXMLString(ElementXML_Handle const hXML,
 ...
 *human-readable
 */
EXPORT int soarxml_DetermineXMLStringLength(ElementXML_Handle const hXML,
                                            bool includeChildren,
                                            bool insertNewLines);
 ...
 * @returns true if attribute name is valid (debug mode only)
 */
EXPORT bool soarxml_AddAttributeFast(ElementXML_Handle hXML,
 ...
 * @returns true if attribute name is valid (debug mode only)
 */
EXPORT bool soarxml_AddAttributeFastFast(ElementXML_Handle hXML,
                                         char const* attributeName,
 ...
 *doc
 */
EXPORT ElementXML_Handle soarxml_ParseXMLFromStringSequence(char const* pString,
                                                            size_t startPos,
                                                            size_t* endPos);
