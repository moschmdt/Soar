...
bool UpdateListener::AddListener(smlUpdateEventId eventID,
...
bool UpdateListener::RemoveListener(smlUpdateEventId eventID,
                                    Connection* pConnection) {
...
void UpdateListener::OnKernelEvent(int eventIDIn, AgentSML* pAgentSML,
                                   void* pCallData) {
