...
class RunScheduler {
 ...
 public:
   ...
   */
  smlRunResult RunScheduledAgents(bool forever, smlRunStepSize runStepSize,
                                  uint64_t count, smlRunFlags runFlags,
 ...
 protected:
  ...
  bool IsAgentFinished(AgentSML* pAgentSML, bool forever,
  ...
  bool TestIfAllFinished(bool forever, smlRunStepSize runStepSize,
                         uint64_t count);
