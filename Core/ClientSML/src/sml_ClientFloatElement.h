...
class EXPORT FloatElement : public WMElement {
 ...
 protected:
  FloatElement(Agent* pAgent, Identifier* pParent, char const* pID,
               char const* pAttributeName, double value, long long timeTag);
  FloatElement(Agent* pAgent, IdentifierSymbol* pParentSymbol, char const* pID,
               char const* pAttributeName, double value, long long timeTag);
