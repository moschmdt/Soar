...
class EXPORT ClientErrors {
 protected:
  ...
  // If we do set this string, it should be displayed instead of the default
  // message based on just the error code.
 ...
 public:
  ...
  /*
   * @brief Classes with virtual functions need a virtual destructor (gcc
   *warning).
   */
