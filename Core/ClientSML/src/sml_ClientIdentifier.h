...
namespace sml
{
    ...
    public:
        ...
        Identifier *GetChildIdentifier(char const *pAttribute) const
        {
            ...
            {
                std::string err_msg = std::string(pAttribute) + " is no identifier of " + std::string(this->GetAttribute());
        ...
        {
            return std::string(FindByAttribute(pAttribute, 0)->ConvertToStringElement()->GetValue());
        }
