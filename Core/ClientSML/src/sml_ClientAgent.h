...
namespace sml
{
    ...
    public:
        ...
        *************************************************************/
        ...
        /*************************************************************
         * @brief This method spawns the Qt debugger to connect to this agent
         *        using Boost.Process for cross-platform process management.
         *
         * @param port The port to connect to (default: -1 uses kernel's listener port)
         * @param debuggerPath Optional explicit path to the debugger executable.
         *                     If NULL or empty, assumes SoarDebugger is installed
         *                     as a system application and available in PATH.
         *
         * @return true if debugger launched successfully, false if:
         *         - Provided debuggerPath is not a valid file
         *         - Process spawning fails
         *         - A previously spawned debugger process is still running
         *
         * @note When debuggerPath is not provided, the system will search for
         *       "SoarDebugger" (or "SoarDebugger.exe" on Windows) in the
         *       system PATH, assuming it was installed via package manager
         *       or added to PATH manually.
         *************************************************************/
        bool SpawnDebugger(int port = -1, const char *debuggerPath = nullptr);
