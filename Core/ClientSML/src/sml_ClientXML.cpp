...
ClientXML::ClientXML() { m_pElementXML = NULL; }

// This constructor is protected so that client doesn't try to build these
// objects. So far they're only built internally and then passed to the client.
ClientXML::ClientXML(ElementXML* pXML) { m_pElementXML = pXML; }
 ...
 */
char* ClientXML::GenerateXMLString(bool includeChildren,
 ...
 *human-readable
 */
int ClientXML::DetermineXMLStringLength(bool includeChildren,
                                        bool insertNewLines) const {
