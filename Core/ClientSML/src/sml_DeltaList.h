...
class EXPORT DeltaList {
 ...
 public:
  ...
  void UpdateWME(long long timeTagToRemove, WMElement* pWME) {
    // This is equivalent to a remove of the old value followed by an add of the
    // new We could choose to use a single tag for this later on.
