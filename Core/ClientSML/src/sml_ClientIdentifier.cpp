...
std::list<WMElement*>::iterator IdentifierSymbol::FindChildByTimeTag(
    long long timeTag) {
...
WMElement* Identifier::FindByAttribute(char const* pAttribute,
  ...
  std::string err_msg = "[Error]: " + this->m_AttributeName +
                        " has no child attribute: " + std::string(pAttribute);
