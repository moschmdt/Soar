 ...
 *************************************************************/
void ClientErrors::SetError(sml::ErrorCode error) { m_LastError = error; }

/*************************************************************
 * @brief Records that an error has occurred and we are overriding
 *        the default message to go with it.
 *************************************************************/
void ClientErrors::SetDetailedError(sml::ErrorCode error,
                                    char const* pDetailedError) {
  m_LastError = error;
 ...
 *************************************************************/
bool ClientErrors::HadError() { return m_LastError != Error::kNoError; }
