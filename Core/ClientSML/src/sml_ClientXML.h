...
class EXPORT ClientXML {
 ...
 protected:
  // This constructor is protected so that client doesn't try to build these
  // objects. So far they're only built internally and then passed to the
  // client. NOTE: We take ownership of the ElementXML object we are passed and
