...
class OutputCommand : public cli::ParserCommand {
 public:
  ...
  virtual const char* GetString() const { return "output"; }
  virtual const char* GetSyntax() const {
    return "Use 'output ?' and 'help output' to learn more about the output "
           "command.";
  }
  ...
  virtual bool Parse(std::vector<std::string>& argv) {
    ...
    OptionsData optionsData[] = {
        {'e', "enable", OPTARG_NONE}, {'d', "disable", OPTARG_NONE},
        {'e', "on", OPTARG_NONE},     {'d', "off", OPTARG_NONE},
        {'a', "add", OPTARG_NONE},    {'A', "append", OPTARG_NONE},
