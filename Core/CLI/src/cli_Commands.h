...
class AliasCommand : public cli::ParserCommand {
 public:
  explicit AliasCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~AliasCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "alias"; }
  ...
  bool Parse(std::vector<std::string>& argv) override {
    ...
    if (num_args == 0) {
      ...
      if (doRemove) {
        if (num_args > 1) {
          return cli.SetError(
              "If your alias has -r or --remove, enclose in quotes.");
        }
        argv.erase(argv.begin());
...
class CDCommand : public cli::ParserCommand {
 public:
  explicit CDCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~CDCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "cd"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    ...
    if (argv.size() > 2) {
      return cli.SetError(
          "Only one argument (a directory) is allowed. Paths with spaces "
...
class DebugCommand : public cli::ParserCommand {
 public:
  explicit DebugCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~DebugCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "debug"; }
  [[nodiscard]] const char* GetSyntax() const override {
    return "Syntax: debug [ allocate | internal-symbols | port | time | ? ] "
           "[arguments*]";
  }
...
class DirsCommand : public cli::ParserCommand {
 public:
  explicit DirsCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~DirsCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "dirs"; }
  [[nodiscard]] const char* GetSyntax() const override {
    return "Syntax: dirs";
  }

  bool Parse(std::vector<std::string>&) override { return cli.DoDirs(); }
...
class EchoCommand : public cli::ParserCommand {
 public:
  explicit EchoCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~EchoCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "echo"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    cli::Options opt;
    OptionsData optionsData[] = {{'n', "nonewline", OPTARG_NONE},
                                 {0, nullptr, OPTARG_NONE}};
...
class EpMemCommand : public cli::ParserCommand {
 public:
  explicit EpMemCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~EpMemCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "epmem"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    ...
    OptionsData optionsData[] = {
        {'b', "backup", OPTARG_NONE},  {'c', "close", OPTARG_NONE},
        {'d', "disable", OPTARG_NONE}, {'d', "off", OPTARG_NONE},
        {'e', "enable", OPTARG_NONE},  {'e', "on", OPTARG_NONE},
        {'i', "init", OPTARG_NONE},    {'g', "get", OPTARG_NONE},
        {'p', "print", OPTARG_NONE},   {'s', "set", OPTARG_NONE},
        {'S', "stats", OPTARG_NONE},   {'t', "timers", OPTARG_NONE},
        {'v', "viz", OPTARG_NONE},     {0, nullptr, OPTARG_NONE}  // null
    };
...
class GPCommand : public cli::ParserCommand {
 public:
  explicit GPCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~GPCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "gp"; }
  [[nodiscard]] const char* GetSyntax() const override {
...
class HelpCommand : public cli::ParserCommand {
 public:
  explicit HelpCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~HelpCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "help"; }
  [[nodiscard]] const char* GetSyntax() const override {
...
class LearnCommand : public cli::ParserCommand {
 public:
  explicit LearnCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~LearnCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "learn"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    cli::Options opt;
    OptionsData optionsData[] = {{'a', "all-levels", OPTARG_NONE},
...
class LSCommand : public cli::ParserCommand {
 public:
  explicit LSCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~LSCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "ls"; }
  [[nodiscard]] const char* GetSyntax() const override { return "Syntax: ls"; }
...
class PopDCommand : public cli::ParserCommand {
 public:
  explicit PopDCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~PopDCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "popd"; }
  [[nodiscard]] const char* GetSyntax() const override {
    return "Syntax: popd";
  }
...
class PreferencesCommand : public cli::ParserCommand {
 public:
  explicit PreferencesCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~PreferencesCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "preferences"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    cli::Options opt;
    OptionsData optionsData[] = {
        {'0', "none", OPTARG_NONE},     {'n', "names", OPTARG_NONE},
        {'1', "names", OPTARG_NONE},    {'N', "names", OPTARG_NONE},
        {'2', "timetags", OPTARG_NONE}, {'t', "timetags", OPTARG_NONE},
        {'3', "wmes", OPTARG_NONE},     {'w', "wmes", OPTARG_NONE},
        {'o', "object", OPTARG_NONE},   {0, nullptr, OPTARG_NONE}};
...
class PrintCommand : public cli::ParserCommand {
 public:
  explicit PrintCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~PrintCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "print"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    cli::Options opt;
    OptionsData optionsData[] = {
        {'a', "all", OPTARG_NONE},       {'c', "chunks", OPTARG_NONE},
        {'d', "depth", OPTARG_REQUIRED}, {'D', "defaults", OPTARG_NONE},
        {'e', "exact", OPTARG_NONE},     {'f', "full", OPTARG_NONE},
        {'F', "filename", OPTARG_NONE},  {'g', "gds", OPTARG_NONE},
        {'i', "internal", OPTARG_NONE},  {'j', "justifications", OPTARG_NONE},
        {'n', "name", OPTARG_NONE},      {'o', "operators", OPTARG_NONE},
        {'r', "rl", OPTARG_NONE},        {'s', "stack", OPTARG_NONE},
        {'S', "states", OPTARG_NONE},    {'t', "tree", OPTARG_NONE},
        {'T', "templates", OPTARG_NONE}, {'u', "user", OPTARG_NONE},
        {'v', "varprint", OPTARG_NONE},  {0, nullptr, OPTARG_NONE}};
    ...
    if (options.test(cli::PRINT_OPERATORS) || options.test(cli::PRINT_STATES)) {
      if (!options.test(cli::PRINT_STACK)) {
        return cli.SetError(
            "Options --operators (-o) and --states (-S) are only valid when "
            "printing the stack.");
      }
    }
    ...
    if (options.test(cli::PRINT_ALL) || options.test(cli::PRINT_CHUNKS) ||
        options.test(cli::PRINT_DEFAULTS) || options.test(cli::PRINT_GDS) ||
        options.test(cli::PRINT_JUSTIFICATIONS) ||
        options.test(cli::PRINT_RL) || options.test(cli::PRINT_TEMPLATE) ||
        options.test(cli::PRINT_USER) || options.test(cli::PRINT_STACK)) {
      return cli.SetError(
          "No argument allowed when printing "
          "all/chunks/defaults/GDS/justifications/rl/template/user/stack.");
    }
    if (options.test(cli::PRINT_EXACT) &&
        (options.test(cli::PRINT_DEPTH) || options.test(cli::PRINT_TREE))) {
      return cli.SetError("No depth/tree flags allowed when printing exact.");
    }

    std::string arg;
    for (size_t i = opt.GetArgument() - opt.GetNonOptionArguments();
         i < argv.size(); ++i) {
      if (!arg.empty()) {
        arg.push_back(' ');
      }
...
class PushDCommand : public cli::ParserCommand {
 public:
  explicit PushDCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~PushDCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "pushd"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    ...
    if (argv.size() > 2) {
      return cli.SetError(
          "Expected on argument (directory). Enclose directory in quotes if "
...
class PWDCommand : public cli::ParserCommand {
 public:
  explicit PWDCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~PWDCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "pwd"; }
  [[nodiscard]] const char* GetSyntax() const override { return "Syntax: pwd"; }
...
class RLCommand : public cli::ParserCommand {
 public:
  explicit RLCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~RLCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "rl"; }
  [[nodiscard]] const char* GetSyntax() const override {
...
class RunCommand : public cli::ParserCommand {
 public:
  explicit RunCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~RunCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "run"; }
  [[nodiscard]] const char* GetSyntax() const override {
    return "Syntax: run  [-f|count]\nrun -[d|e|o|p][s][un][g] [f|count]\nrun "
           "-[d|e|o|p][un] count [-i e|p|d|o]";
  }

  bool Parse(std::vector<std::string>& argv) override {
    cli::Options opt;
    OptionsData optionsData[] = {
        {'d', "decision", OPTARG_NONE}, {'e', "elaboration", OPTARG_NONE},
        {'g', "goal", OPTARG_NONE},     {'i', "interleave", OPTARG_REQUIRED},
        {'n', "noupdate", OPTARG_NONE}, {'o', "output", OPTARG_NONE},
        {'p', "phase", OPTARG_NONE},    {'s', "self", OPTARG_NONE},
        {'u', "update", OPTARG_NONE},   {0, nullptr, OPTARG_NONE}};
    ...
    bool specifiedType =
        (options.test(cli::RUN_ELABORATION) ||
         options.test(cli::RUN_DECISION) || options.test(cli::RUN_PHASE) ||
         options.test(cli::RUN_OUTPUT));
    ...
    if (opt.GetNonOptionArguments() == 1) {
      ...
      // Allow "run 0" for decisions -- which means run agents to the current
      // stop-before phase
      if (count < 0 ||
          (count == 0 && specifiedType && !options.test(cli::RUN_DECISION))) {
...
class SMemCommand : public cli::ParserCommand {
 public:
  explicit SMemCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~SMemCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "smem"; }
  [[nodiscard]] const char* GetSyntax() const override {
  ...
  bool Parse(std::vector<std::string>& argv) override {
    cli::Options opt;
    OptionsData optionsData[] = {
        {'a', "add", OPTARG_NONE},     {'b', "backup", OPTARG_NONE},
        {'c', "clear", OPTARG_NONE},   {'d', "disable", OPTARG_NONE},
        {'d', "off", OPTARG_NONE},     {'e', "enable", OPTARG_NONE},
        {'e', "on", OPTARG_NONE},      {'g', "get", OPTARG_NONE},
        {'h', "history", OPTARG_NONE},  // Testing/unstable - 23-7-2014
        {'i', "init", OPTARG_NONE},    {'P', "precalculate", OPTARG_NONE},
        ...
        {'t', "timers", OPTARG_NONE},  {'x', "export", OPTARG_NONE},
        {0, nullptr, OPTARG_NONE}  // null
    };
    ...
    switch (option) {
      ...
      case 'q': {
        // case: query requires one non-option argument, but can have a depth
        // argument
        if (!opt.CheckNumNonOptArgs(1, 2)) {
          return cli.SetError(opt.GetError());
        }
        ...
        return cli.DoSMem(option, &(argv[2]),
                          &(argv[3]));  // This is the case of "depth".
      }
      ...
      case 'r': {
        // case: remove requires one non-option argument, but can have a "force"
        // argument
        if (!opt.CheckNumNonOptArgs(1, 2)) {
          return cli.SetError(opt.GetError());
        }
...
class SPCommand : public cli::ParserCommand {
 public:
  explicit SPCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~SPCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "sp"; }
  [[nodiscard]] const char* GetSyntax() const override {
    return "Syntax: sp {production_body}";
  }
...
class StatsCommand : public cli::ParserCommand {
 public:
  explicit StatsCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~StatsCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "stats"; }
  [[nodiscard]] const char* GetSyntax() const override {
    return "Syntax: stats [options]";
  }

  bool Parse(std::vector<std::string>& argv) override {
    cli::Options opt;
    OptionsData optionsData[] = {
        {'d', "decision", OPTARG_NONE},   {'l', "learning", OPTARG_NONE},
        {'m', "memory", OPTARG_NONE},     {'M', "max", OPTARG_NONE},
        {'r', "rete", OPTARG_NONE},       {'s', "system", OPTARG_NONE},
        {'R', "reset", OPTARG_NONE},      {'t', "track", OPTARG_NONE},
        {'T', "stop-track", OPTARG_NONE}, {'c', "cycle", OPTARG_NONE},
        {'C', "cycle-csv", OPTARG_NONE},  {'S', "sort", OPTARG_REQUIRED},
        {'a', "agent", OPTARG_NONE},      {0, nullptr, OPTARG_NONE}};
...
class SVSCommand : public cli::ParserCommand {
 public:
  explicit SVSCommand(cli::CommandLineInterface& cli)
      : ParserCommand(), cli(cli) {}
  ~SVSCommand() override = default;
  [[nodiscard]] const char* GetString() const override { return "svs"; }
  [[nodiscard]] const char* GetSyntax() const override {
    return "Syntax: svs <elements to inspect>\n"
           "        svs [--enable | -e | --on | --disable | -d | --off | "
           "--enable-in-substates | --disable-in-substates ]";
  }
