...
class VisualizeCommand : public cli::ParserCommand {
 public:
  VisualizeCommand(cli::CommandLineInterface& cli)
      : cli(cli), ParserCommand() {}
  virtual ~VisualizeCommand() {}
  virtual const char* GetString() const { return "visualize"; }
  virtual const char* GetSyntax() const {
    return "Use 'visualize ?' or 'help soar' to learn more about the visualize "
           "command.";
  }
