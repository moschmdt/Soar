...
class WMCommand : public cli::ParserCommand {
 public:
  ...
  virtual ~WMCommand() {}
  virtual const char* GetString() const { return "wm"; }
  ...
  virtual bool Parse(std::vector<std::string>& argv) {
    ...
    OptionsData optionsData[] = {
        {'a', "add-filter", OPTARG_NONE},    {'g', "get", OPTARG_NONE},
        {'h', "history", OPTARG_NONE},       {'l', "list-filter", OPTARG_NONE},
        {'r', "remove-filter", OPTARG_NONE}, {'R', "reset-filter", OPTARG_NONE},
    ...
    if (!opt.GetNonOptionArguments()) {
      return cli.SetError(
          "The 'wm' commands contains commands and settings related to working "
          "memomory: add, remove, activation and watch.\n\n"
          "Use 'wm ?' to see an overview of the command or 'help wm' to read "
          "the manual page.");
    }
    std::string lCmd;
