...
static void
vset(double v[3], double x, double y, double z)
{
	v[0] = x;
	v[1] = y;
	v[2] = z;
...
static void
vsub(const double src1[3], const double src2[3], double dst[3])
{
	dst[0] = src1[0] - src2[0];
	dst[1] = src1[1] - src2[1];
	dst[2] = src1[2] - src2[2];
...
static void
vcopy(const double v1[3], double v2[3])
{
	register int i;
	for (i = 0 ; i < 3 ; i++)
		v2[i] = v1[i];
...
static void
vcross(const double v1[3], const double v2[3], double cross[3])
{
	double temp[3];
...
static double
vlength(const double v[3])
{
	return sqrt(v[0] * v[0] + v[1] * v[1] + v[2] * v[2]);
}

static void
vscale(double v[3], double div)
{
	v[0] *= div;
	v[1] *= div;
	v[2] *= div;
...
static double
vdot(const double v1[3], const double v2[3])
{
	return v1[0]*v2[0] + v1[1]*v2[1] + v1[2]*v2[2];
}

static void
vadd(const double src1[3], const double src2[3], double dst[3])
{
	dst[0] = src1[0] + src2[0];
	dst[1] = src1[1] + src2[1];
	dst[2] = src1[2] + src2[2];
