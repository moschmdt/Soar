...
class Transform {
 ...
 public:
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC Transform& operator=(
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE const typename internal::
      transform_right_product_impl<Transform, OtherDerived>::ResultType
   ...
   */
  template <typename DiagonalDerived>
  EIGEN_DEVICE_FUNC friend inline TransformTimeDiagonalReturnType operator*(
 ...
 public:
  ...
  operator*(
    ...
    return internal::transform_transform_product_impl<
        Transform,
        Transform<Scalar, Dim, OtherMode, OtherOptions> >::run(*this, other);
  }
#endif
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC inline Transform& scale(
      const MatrixBase<OtherDerived>& other);

  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC inline Transform& prescale(
      const MatrixBase<OtherDerived>& other);
  ...
  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC inline Transform& translate(
      const MatrixBase<OtherDerived>& other);

  template <typename OtherDerived>
  EIGEN_DEVICE_FUNC inline Transform& pretranslate(
      const MatrixBase<OtherDerived>& other);
  ...
  EIGEN_DEVICE_FUNC
  inline TransformTimeDiagonalReturnType operator*(
  ...
  EIGEN_DEVICE_FUNC bool isApprox(
      const Transform& other, const typename NumTraits<Scalar>::Real& prec =
...
struct transform_rotation_impl<Isometry> {
  template <typename TransformType>
  EIGEN_DEVICE_FUNC static inline typename TransformType::ConstLinearPart run(
