...
class Translation {
 ...
 public:
  ...
  EIGEN_DEVICE_FUNC inline IsometryTransformType operator*(
  ...
  friend EIGEN_DEVICE_FUNC inline AffineTransformType operator*(
      const EigenBase<OtherDerived>& linear, const Translation& t) {
  ...
  EIGEN_DEVICE_FUNC inline typename internal::cast_return_type<
      Translation, Translation<NewScalarType, Dim> >::type
  cast() const {
