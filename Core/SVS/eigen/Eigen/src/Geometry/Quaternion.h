...
class QuaternionBase : public RotationBase<Derived, 3> {
 public:
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE QuaternionBase<Derived>& operator=(
   ...
   */
  template <class OtherDerived>
  EIGEN_DEVICE_FUNC inline Scalar dot(
  ...
  template <class OtherDerived>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Quaternion<Scalar> operator*(
...
class Quaternion : public QuaternionBase<Quaternion<_Scalar, _Options> > {
 public:
  ...
  template <typename Derived1, typename Derived2>
  EIGEN_DEVICE_FUNC static Quaternion FromTwoVectors(
...
EIGEN_DEVICE_FUNC inline Derived& QuaternionBase<Derived>::operator=(
...
template <class Derived>
template <typename Derived1, typename Derived2>
EIGEN_DEVICE_FUNC inline Derived& QuaternionBase<Derived>::setFromTwoVectors(
    const MatrixBase<Derived1>& a, const MatrixBase<Derived2>& b) {
