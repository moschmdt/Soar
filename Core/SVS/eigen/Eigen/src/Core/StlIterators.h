...
class indexed_based_stl_iterator_base {
 ...
 public:
  ...
  difference_type operator-(
      const indexed_based_stl_iterator_base& other) const {
...
class indexed_based_stl_reverse_iterator_base {
 ...
 public:
  ...
  indexed_based_stl_reverse_iterator_base& operator=(
  ...
  difference_type operator-(
      const indexed_based_stl_reverse_iterator_base& other) const {
    eigen_assert(mp_xpr == other.mp_xpr);
...
class pointer_based_stl_iterator {
 ...
 public:
  ...
  friend pointer_based_stl_iterator operator+(
  ...
  friend pointer_based_stl_iterator operator+(
      Index a, const pointer_based_stl_iterator& b) {
 ...
 */
template <typename Derived>
inline typename DenseBase<Derived>::const_iterator DenseBase<Derived>::cbegin()
    const {
  EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived);
 ...
 */
template <typename Derived>
inline typename DenseBase<Derived>::const_iterator DenseBase<Derived>::cend()
    const {
  EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived);
