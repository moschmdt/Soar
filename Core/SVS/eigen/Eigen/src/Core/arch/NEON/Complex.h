...
template <>
EIGEN_DEVICE_FUNC inline Packet1cf pgather<std::complex<float>, Packet1cf>(
...
template <>
EIGEN_DEVICE_FUNC inline void pscatter<std::complex<float>, Packet1cf>(
...
template <>
EIGEN_STRONG_INLINE std::complex<float> predux_mul<Packet1cf>(
    const Packet1cf& a) {
  std::complex<float> s;
  vst1_f32((float*)&s, a.v);
  return s;
