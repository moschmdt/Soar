...
class gebp_traits<std::complex<RealScalar>, std::complex<RealScalar>, _ConjLhs,
 ...
 public:
  ...
  EIGEN_STRONG_INLINE void loadLhs(const LhsScalar* a, LhsPacket& dest) const {
    dest =
        pload<LhsPacket>((const typename unpacket_traits<LhsPacket>::type*)(a));
  }
...
struct lhs_process_one_packet {
  ...
  EIGEN_STRONG_INLINE void peeled_kc_onestep(
      Index K, const LhsScalar* blA, const RhsScalar* blB, GEBPTraits traits,
  ...
  EIGEN_STRONG_INLINE void operator()(
      ...
      Index peeled_kc, Index pk, Index cols, Index depth, Index packet_cols4) {
    GEBPTraits traits;
...
struct lhs_process_fraction_of_packet
  ...
  EIGEN_STRONG_INLINE void peeled_kc_onestep(Index K, const LhsScalar* blA,
                                             const RhsScalar* blB,
                                             GEBPTraits traits, LhsPacket* A0,
                                             RhsPacket* B_0, RhsPacket* B1,
                                             RhsPacket* B2, RhsPacket* B3,
                                             AccPacket* C0, AccPacket* C1,
