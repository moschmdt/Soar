...
struct ldlt_inplace<Upper> {
  ...
  template <typename MatrixType, typename TranspositionType, typename Workspace,
            typename WType>
  static EIGEN_STRONG_INLINE bool update(
      MatrixType& mat, TranspositionType& transpositions, Workspace& tmp,
...
template <typename InputType>
LDLT<MatrixType, _UpLo>& LDLT<MatrixType, _UpLo>::compute(
