...
#define CCD_VEC3(name, x, y, z) ccd_vec3_t name = CCD_VEC3_STATIC((x), (y), (z))
 ...
 */
ccd_real_t ccdVec3PointTriDist2(const ccd_vec3_t *P, const ccd_vec3_t *a,
...
_ccd_inline int ccdIsZero(ccd_real_t val) { return CCD_FABS(val) < CCD_EPS; }
...
_ccd_inline int ccdEq(ccd_real_t _a, ccd_real_t _b) {
  ...
  ab = CCD_FABS(_a - _b);
  if (CCD_FABS(ab) < CCD_EPS) return 1;
...
_ccd_inline ccd_real_t ccdVec3X(const ccd_vec3_t *v) { return v->v[0]; }

_ccd_inline ccd_real_t ccdVec3Y(const ccd_vec3_t *v) { return v->v[1]; }

_ccd_inline ccd_real_t ccdVec3Z(const ccd_vec3_t *v) { return v->v[2]; }

_ccd_inline int ccdVec3Eq(const ccd_vec3_t *a, const ccd_vec3_t *b) {
  return ccdEq(ccdVec3X(a), ccdVec3X(b)) && ccdEq(ccdVec3Y(a), ccdVec3Y(b)) &&
...
_ccd_inline void ccdVec3Copy(ccd_vec3_t *v, const ccd_vec3_t *w) { *v = *w; }
