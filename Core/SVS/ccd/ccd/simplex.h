...
_ccd_inline const ccd_support_t *ccdSimplexPoint(const ccd_simplex_t *s,
                                                 int idx);
...
_ccd_inline void ccdSimplexSet(ccd_simplex_t *s, size_t pos,
...
_ccd_inline int ccdSimplexSize(const ccd_simplex_t *s) { return s->last + 1; }
