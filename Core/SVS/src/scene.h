...
class scene : public sgnode_listener, public cliproxy {
 ...
 private:
  ...
  int parse_object_query(std::vector<std::string>& f, std::string& result,
                         std::string& error) const;
  int parse_list_all_objects_query(std::vector<std::string>& f,
                                   std::string& result,
                                   std::string& error) const;
  int parse_objects_with_flag_query(std::vector<std::string>& f,
                                    std::string& result,
                                    std::string& error) const;
};
