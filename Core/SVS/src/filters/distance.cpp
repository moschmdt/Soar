...
///// filter distance filter* make_distance_filter(Symbol* root, soar_interface*
/// si, scene* scn,
                             filter_input* input) {
                               return new node_comparison_filter(
                                   root, si, input, &compare_distance);
                             }
                             ...
                             filter_table_entry* distance_filter_entry() {
                               ...
                               e->parameters["distance_type"] =
                                   "Either centroid or hull";
                               e->create = &make_distance_filter;
                               return e;
                             }

                             ///// filter distance_select filter*
                             /// make_distance_select_filter(Symbol* root,
                             /// soar_interface* si,
                                    ...
                                    ////// filter closest filter*
                                    /// make_closest_filter(Symbol* root,
                                    /// soar_interface* si, scene* scn,
                            filter_input* input) {
                              node_comparison_rank_filter* f =
                                  new node_comparison_rank_filter(
                                      root, si, input, &compare_distance);
                            ...
                            filter_table_entry* closest_filter_entry() {
                              ...
                              e->name = "closest";
                              e->description =
                                  "Output node b closest to node a";
                              e->parameters["a"] = "Sgnode a";
                              e->parameters["b"] = "Sgnode b";
                              e->parameters["distance_type"] =
                                  "Either centroid or hull";
                            ...
                            ////// filter farthest filter*
                            /// make_farthest_filter(Symbol* root,
                            /// soar_interface* si, scene* scn,
                             filter_input* input) {
                               return new node_comparison_rank_filter(
                                   root, si, input, &compare_distance);
                             }
                             ...
                             filter_table_entry* farthest_filter_entry() {
                               ...
                               e->name = "farthest";
                               e->description =
                                   "Output node b farthest from node a";
                               e->parameters["a"] = "Sgnode a";
                               e->parameters["b"] = "Sgnode b";
                               e->parameters["distance_type"] =
                                   "Either centroid or hull";
