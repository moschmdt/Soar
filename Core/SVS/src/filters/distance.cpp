...
///// filter distance //////
filter* make_distance_filter(Symbol* root, soar_interface* si, scene* scn,
                             filter_input* input) {
...
filter* make_distance_select_filter(Symbol* root, soar_interface* si,
...
////// filter closest //////
filter* make_closest_filter(Symbol* root, soar_interface* si, scene* scn,
                            filter_input* input) {
  node_comparison_rank_filter* f =
      new node_comparison_rank_filter(root, si, input, &compare_distance);
...
////// filter farthest //////
filter* make_farthest_filter(Symbol* root, soar_interface* si, scene* scn,
                             filter_input* input) {
