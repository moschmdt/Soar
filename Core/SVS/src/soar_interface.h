...
inline Symbol* soar_interface::get_wme_id(wme* w) { return w->id; }

inline Symbol* soar_interface::get_wme_attr(wme* w) { return w->attr; }

inline Symbol* soar_interface::get_wme_val(wme* w) { return w->value; }

inline uint64_t soar_interface::get_timetag(wme* w) { return w->timetag; }

template <class T>
bool soar_interface::get_const_attr(Symbol* id, const std::string& attr,
                                    T& val) {
  wme* w;
