...
void command_table::add(command_table_entry* e) { table[e->name] = e; }
...
void command_table::proxy_use_sub(const std::vector<std::string>& args,
                                  std::ostream& os) {
  os << "====================== COMMAND TABLE ======================="
     << std::endl;
  ...
  os << "==========================================================="
     << std::endl;
  os << "For specific command info, use the command 'svs commands.command_name'"
     << std::endl;
}

command_table_entry::command_table_entry() : create(NULL), description("") {
  set_help("Reports information about this command");
}

void command_table_entry::proxy_use_sub(const std::vector<std::string>& args,
                                        std::ostream& os) {
