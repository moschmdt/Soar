...
char const* const sml_Names::kStatusCreated =
    "created";  // Initial status -- simply means connection exists
char const* const sml_Names::kStatusNotReady =
    "not-ready";  // Connection not ready (work needs to be done still)
char const* const sml_Names::kStatusReady =
    "ready";  // Connection ready (registered for events etc.)
char const* const sml_Names::kStatusClosing =
    "closing";  // Connection about to shut down
...
char const* const sml_Names::kTagProduction_Retracting =
    "retracting_production";
...
char const* const sml_Names::kFilterName =
    "_sml::filter";  // This name goes into the RHS function name space, so want
                     // it to be unlikely to be used by clients
char const* const sml_Names::kParamNoFiltering = "nofilter";

// production printing
char const* const sml_Names::kTagConditions = "conditions";
char const* const sml_Names::kTagConjunctive_Negation_Condition =
...
char const* const sml_Names::kProductionTypeJustification =
...
char const* const sml_Names::kParamLearnAllLevelsSetting =
    "learnalllevelssetting";
char const* const sml_Names::kParamLearnForceLearnStates =
    "learnforcelearnstates";
char const* const sml_Names::kParamLearnDontLearnStates =
    "learndontlearnstates";
...
char const* const sml_Names::kParamIndifferentSelectionMode =
    "indifferentselectionmode";
char const* const sml_Names::kParamNumericIndifferentMode =
    "numericindifferentmode";
...
char const* const sml_Names::kParamSourcedProductionCount =
    "sourced-production-count";
char const* const sml_Names::kParamExcisedProductionCount =
    "excised-production-count";
char const* const sml_Names::kParamIgnoredProductionCount =
    "ignored-production-count";

// Parameter names for stats command
char const* const sml_Names::kParamStatsProductionCountDefault =
    "statsproductioncountdefault";
char const* const sml_Names::kParamStatsProductionCountUser =
    "statsproductioncountuser";
char const* const sml_Names::kParamStatsProductionCountChunk =
    "statsproductioncountchunk";
char const* const sml_Names::kParamStatsProductionCountJustification =
    "statsproductioncountjustification";
char const* const sml_Names::kParamStatsCycleCountDecision =
    "statscyclecountdecision";
char const* const sml_Names::kParamStatsCycleCountElaboration =
    "statscyclecountelaboration";
char const* const sml_Names::kParamStatsCycleCountInnerElaboration =
    "statscyclecountinnerelaboration";
char const* const sml_Names::kParamStatsProductionFiringCount =
    "statsproductionfiringcount";
char const* const sml_Names::kParamStatsWmeCountAddition =
    "statswmecountaddition";
char const* const sml_Names::kParamStatsWmeCountRemoval =
    "statswmecountremoval";
char const* const sml_Names::kParamStatsWmeCount = "statswmecount";
char const* const sml_Names::kParamStatsWmeCountAverage =
    "statswmecountsverage";
...
char const* const sml_Names::kParamStatsPhaseTimeInputPhase =
    "statsphasetimeinputphase";
char const* const sml_Names::kParamStatsPhaseTimeProposePhase =
    "statsphasetimeproposephase";
char const* const sml_Names::kParamStatsPhaseTimeDecisionPhase =
    "statsphasetimedecisionphase";
char const* const sml_Names::kParamStatsPhaseTimeApplyPhase =
    "statsphasetimeapplyphase";
char const* const sml_Names::kParamStatsPhaseTimeOutputPhase =
    "statsphasetimeoutputphase";
char const* const sml_Names::kParamStatsPhaseTimePreferencePhase =
    "statsphasetimepreferencephase";
char const* const sml_Names::kParamStatsPhaseTimeWorkingMemoryPhase =
    "statsphasetimeworkingmemoryphase";

char const* const sml_Names::kParamStatsMonitorTimeInputPhase =
    "statsmonitortimeinputphase";
char const* const sml_Names::kParamStatsMonitorTimeProposePhase =
    "statsmonitortimeproposephase";
char const* const sml_Names::kParamStatsMonitorTimeDecisionPhase =
    "statsmonitortimedecisionphase";
char const* const sml_Names::kParamStatsMonitorTimeApplyPhase =
    "statsmonitortimeapplyphase";
char const* const sml_Names::kParamStatsMonitorTimeOutputPhase =
    "statsmonitortimeoutputphase";
char const* const sml_Names::kParamStatsMonitorTimePreferencePhase =
    "statsmonitortimepreferencephase";
char const* const sml_Names::kParamStatsMonitorTimeWorkingMemoryPhase =
    "statsmonitortimeworkingmemoryphase";

char const* const sml_Names::kParamStatsInputFunctionTime =
    "statsinputfunctiontime";
char const* const sml_Names::kParamStatsOutputFunctionTime =
    "statsoutputfunctiontime";

char const* const sml_Names::kParamStatsMatchTimeInputPhase =
    "statsmatchtimeinputphase";
char const* const sml_Names::kParamStatsMatchTimePreferencePhase =
    "statsmatchtimepreferencephase";
char const* const sml_Names::kParamStatsMatchTimeWorkingMemoryPhase =
    "statsmatchtimeworkingmemoryphase";
char const* const sml_Names::kParamStatsMatchTimeOutputPhase =
    "statsmatchtimeoutputphase";
char const* const sml_Names::kParamStatsMatchTimeDecisionPhase =
    "statsmatchtimedecisionphase";
char const* const sml_Names::kParamStatsMatchTimeProposePhase =
    "statsmatchtimedecisionphase";
char const* const sml_Names::kParamStatsMatchTimeApplyPhase =
    "statsmatchtimedecisionphase";

char const* const sml_Names::kParamStatsOwnershipTimeInputPhase =
    "statsownershiptimeinputphase";
char const* const sml_Names::kParamStatsOwnershipTimePreferencePhase =
    "statsownershiptimepreferencephase";
char const* const sml_Names::kParamStatsOwnershipTimeWorkingMemoryPhase =
    "statsownershiptimeworkingmemoryphase";
char const* const sml_Names::kParamStatsOwnershipTimeOutputPhase =
    "statsownershiptimeoutputphase";
char const* const sml_Names::kParamStatsOwnershipTimeDecisionPhase =
    "statsownershiptimedecisionphase";
char const* const sml_Names::kParamStatsOwnershipTimeProposePhase =
    "statsownershiptimedecisionphase";
char const* const sml_Names::kParamStatsOwnershipTimeApplyPhase =
    "statsownershiptimedecisionphase";

char const* const sml_Names::kParamStatsChunkingTimeInputPhase =
    "statschunkingtimeinputphase";
char const* const sml_Names::kParamStatsChunkingTimePreferencePhase =
    "statschunkingtimepreferencephase";
char const* const sml_Names::kParamStatsChunkingTimeWorkingMemoryPhase =
    "statschunkingtimeworkingmemoryphase";
char const* const sml_Names::kParamStatsChunkingTimeOutputPhase =
    "statschunkingtimeoutputphase";
char const* const sml_Names::kParamStatsChunkingTimeDecisionPhase =
    "statschunkingtimedecisionphase";
char const* const sml_Names::kParamStatsChunkingTimeProposePhase =
    "statschunkingtimedecisionphase";
char const* const sml_Names::kParamStatsChunkingTimeApplyPhase =
    "statschunkingtimedecisionphase";

char const* const sml_Names::kParamStatsGDSTimeInputPhase =
    "statsgdstimeinputphase";
char const* const sml_Names::kParamStatsGDSTimePreferencePhase =
    "statsgdstimepreferencephase";
char const* const sml_Names::kParamStatsGDSTimeWorkingMemoryPhase =
    "statsgdstimeworkingmemoryphase";
char const* const sml_Names::kParamStatsGDSTimeOutputPhase =
    "statsgdstimeoutputphase";
char const* const sml_Names::kParamStatsGDSTimeDecisionPhase =
    "statsgdstimedecisionphase";
char const* const sml_Names::kParamStatsGDSTimeProposePhase =
    "statsgdstimedecisionphase";
char const* const sml_Names::kParamStatsGDSTimeApplyPhase =
    "statsgdstimedecisionphase";

char const* const sml_Names::kParamStatsMemoryUsageMiscellaneous =
    "statsmemoryusagemiscellaneous";
char const* const sml_Names::kParamStatsMemoryUsageHash =
    "statsmemoryusagehash";
char const* const sml_Names::kParamStatsMemoryUsageString =
    "statsmemoryusagestring";
char const* const sml_Names::kParamStatsMemoryUsagePool =
    "statsmemoryusagepool";
char const* const sml_Names::kParamStatsMemoryUsageStatsOverhead =
    "statsmemoryusagestatsoverhead";
char const* const sml_Names::kParamStatsMaxDecisionCycleTimeValueSec =
    "statsmaxdecisioncycletimevaluesec";
char const* const sml_Names::kParamStatsMaxDecisionCycleTimeValueUSec =
    "statsmaxdecisioncycletimevalueusec";
char const* const sml_Names::kParamStatsMaxDecisionCycleTimeCycle =
    "statsmaxdecisioncycletimecycle";
char const* const sml_Names::kParamStatsMaxDecisionCycleWMChangesCycle =
    "statsmaxdecisioncyclewmchangescycle";
char const* const sml_Names::kParamStatsMaxDecisionCycleWMChangesValue =
    "statsmaxdecisioncyclewmchangesvalue";
char const* const sml_Names::kParamStatsMaxDecisionCycleEpMemTimeCycle =
    "statsmaxdecisioncycleepmemtimecycle";
char const* const sml_Names::kParamStatsMaxDecisionCycleEpMemTimeValueSec =
    "statsmaxdecisioncycleepmemtimevaluesec";
char const* const sml_Names::kParamStatsMaxDecisionCycleSMemTimeCycle =
    "statsmaxdecisioncyclesmemtimecycle";
char const* const sml_Names::kParamStatsMaxDecisionCycleSMemTimeValueSec =
    "statsmaxdecisioncyclesmemtimevaluesec";
char const* const sml_Names::kParamStatsMaxDecisionCycleFireCountCycle =
    "statsmaxdecisioncyclefirecountcycle";
char const* const sml_Names::kParamStatsMaxDecisionCycleFireCountValue =
    "statsmaxdecisioncyclefirecountvalue";
...
char const* const sml_Names::kParamWatchProductionDefault =
    "watchproductiondefault";
char const* const sml_Names::kParamWatchProductionUser = "watchproductionuser";
char const* const sml_Names::kParamWatchProductionChunks =
    "watchproductionchunks";
char const* const sml_Names::kParamWatchProductionJustifications =
    "watchproductionjustifications";
char const* const sml_Names::kParamWatchProductionTemplates =
    "watchproductiontemplates";
char const* const sml_Names::kParamWatchWMEDetail = "watchwmedetail";
char const* const sml_Names::kParamWatchWorkingMemoryChanges =
    "watchworkingmemorychanges";
...
char const* const sml_Names::kParamWatchIndifferentSelection =
    "watchindifferentselection";
...
char const* const sml_Names::kParamWatchGDSStateRemoval =
    "watchgdsstateremoval";
...
char const* const sml_Names::kCommand_UnregisterForEvent =
...
char const* const sml_Names::kCommand_CheckForIncomingCommands =
    "check_for_incoming_commands";
char const* const sml_Names::kCommand_SetInterruptCheckRate =
    "set_interrupt_check_rate";
...
char const* const sml_Names::kCommand_IsProductionLoaded =
