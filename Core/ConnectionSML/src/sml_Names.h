...
class EXPORT sml_Names {
 public:
  ...
  static char const* const
      kStatusCreated;  // Initial status -- simply means connection exists
  static char const* const
      kStatusNotReady;  // Connection not ready (work needs to be done still)
  static char const* const
      kStatusReady;  // Connection ready (registered for events etc.)
