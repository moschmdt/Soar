...
Events::Events() {
  ...
  RegisterEvent(smlEVENT_BEFORE_DECIDE_PHASE, "before-decide-phase");
  ...
  RegisterEvent(smlEVENT_BEFORE_PREFERENCE_PHASE,
                "before-preference-phase");  // Soar-7 mode only
  RegisterEvent(smlEVENT_BEFORE_WM_PHASE,
                "before-wm-phase");  // Soar-7 mode only
  RegisterEvent(smlEVENT_AFTER_INPUT_PHASE, "after-input-phase");
  RegisterEvent(smlEVENT_AFTER_PROPOSE_PHASE, "after-propose-phase");
  RegisterEvent(smlEVENT_AFTER_DECIDE_PHASE, "after-decide-phase");
  RegisterEvent(smlEVENT_AFTER_APPLY_PHASE, "after-apply-phase");
  RegisterEvent(smlEVENT_AFTER_OUTPUT_PHASE, "after-output-phase");
  RegisterEvent(smlEVENT_AFTER_PREFERENCE_PHASE,
                "after-preference-phase");                   // Soar-7 mode only
  ...
  RegisterEvent(smlEVENT_BEFORE_PRODUCTION_RETRACTED,
                "before-production-retracted");
  ...
  RegisterEvent(smlEVENT_BEFORE_AGENT_REINITIALIZED,
                "before-agent-reinitialized");
  RegisterEvent(smlEVENT_AFTER_AGENT_REINITIALIZED,
  ...
  RegisterEvent(smlEVENT_AFTER_ALL_GENERATED_OUTPUT,
                "after-all-generated-output");
