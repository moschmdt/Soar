  ...
  for (c = args; c != NIL; c = c->rest) {
    ...
    if ((arg->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
      ...
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: non-number (%y) passed to + function\n", arg);
      return NIL;
    }
  }
...
Symbol* minus_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: '-' function called with no arguments\n");
    return NIL;
  }
...
Symbol* fp_divide_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (!args->rest) {
    ...
    thisAgent->outputManager->printa(
        thisAgent, "Error: attempt to divide ('/') by zero.\n");
    return NIL;
  }
...
Symbol* div_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (arg1->symbol_type != INT_CONSTANT_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: non-integer (%y) passed to div function\n", arg1);
    return NIL;
  }
  ...
  if (arg2->ic->value == 0) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: attempt to divide ('div') by zero.\n");
    return NIL;
  }

  return thisAgent->symbolManager->make_int_constant(arg1->ic->value /
                                                     arg2->ic->value);
  /* Warning: ANSI doesn't say precisely what happens if one or both of the
     two args is negative. */
}

Symbol* size_rhs_function_code(agent* thisAgent, cons* args,
                               void* /*user_data*/) {
  Symbol* arg1;
  slot* s;
  wme* w;
  ...
  if (arg1->symbol_type != IDENTIFIER_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: non-symbol (%y) passed to size function\n", arg1);
    return NIL;
  }
  int count = 0;
...
Symbol* sum_rhs_function_code(agent* thisAgent, cons* args,
                              void* /*user_data*/) {
  Symbol* arg1;
  slot* s;
  wme* w;
  ...
  if (arg1->symbol_type != IDENTIFIER_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: non-symbol (%y) passed to sum function\n", arg1);
    return NIL;
  }
  int sum = 0;
...
Symbol* product_rhs_function_code(agent* thisAgent, cons* args,
                                  void* /*user_data*/) {
  Symbol* arg1;
  slot* s;
  wme* w;
  ...
  if (arg1->symbol_type != IDENTIFIER_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: non-symbol (%y) passed to product function\n", arg1);
    return NIL;
  }
  int product = 1;
...
Symbol* mod_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (arg1->symbol_type != INT_CONSTANT_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: non-integer (%y) passed to mod function\n", arg1);
    return NIL;
  }
  if (arg2->symbol_type != INT_CONSTANT_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
  ...
  if (arg2->ic->value == 0) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: attempt to divide ('mod') by zero.\n");
    return NIL;
  }
...
Symbol* min_rhs_function_code(agent* thisAgent, cons* args,
  ...
  for (c = args; c != NIL; c = c->rest) {
    ...
    if ((arg->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
        (arg->symbol_type != FLOAT_CONSTANT_SYMBOL_TYPE)) {
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: non-number (%y) passed to min function\n", arg);
      return NIL;
    }
  }
...
Symbol* max_rhs_function_code(agent* thisAgent, cons* args,
  ...
  for (c = args; c != NIL; c = c->rest) {
    ...
    if ((arg->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
        (arg->symbol_type != FLOAT_CONSTANT_SYMBOL_TYPE)) {
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: non-number (%y) passed to max function\n", arg);
      return NIL;
    }
  }
 ...
 */
Symbol* sin_rhs_function_code(agent* thisAgent, cons* args,
                              void* /*user_data*/) {
  Symbol* arg;
  double arg_value;
  ...
  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'sin' function called with no arguments\n");
    return NIL;
  }
 ...
 */
Symbol* cos_rhs_function_code(agent* thisAgent, cons* args,
                              void* /*user_data*/) {
  Symbol* arg;
  double arg_value;
  ...
  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'cos' function called with no arguments\n");
    return NIL;
  }
 ...
 */
Symbol* sqrt_rhs_function_code(agent* thisAgent, cons* args,
                               void* /*user_data*/) {
  Symbol* arg;
  double arg_value;
  ...
  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'sqrt' function called with no arguments\n");
    return NIL;
  }
 ...
 */
Symbol* atan2_rhs_function_code(agent* thisAgent, cons* args,
                                void* /*user_data*/) {
  Symbol* arg;
  cons* c;
  double numer_value, denom_value;

  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'atan2' function called with no arguments\n");
    return NIL;
  }
  ...
  for (c = args; c != NIL; c = c->rest) {
    ...
    if ((arg->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
        (arg->symbol_type != FLOAT_CONSTANT_SYMBOL_TYPE)) {
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: non-number (%y) passed to atan2\n", arg);
      return NIL;
    }
  }
  ...
  if (!args->rest) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'atan2' function called with only one argument\n");
    return NIL;
  }
  ...
  return thisAgent->symbolManager->make_float_constant(
 ...
 */
Symbol* abs_rhs_function_code(agent* thisAgent, cons* args,
                              void* /*user_data*/) {
  Symbol *arg, *return_value;

  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'abs' function called with no arguments\n");
    return NIL;
  }
  ...
  if (arg->symbol_type == FLOAT_CONSTANT_SYMBOL_TYPE) {
    return_value =
        thisAgent->symbolManager->make_float_constant(fabs(arg->fc->value));
  } else if (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE) {
    return_value = thisAgent->symbolManager->make_int_constant(
        (arg->ic->value < 0) ? -arg->ic->value : arg->ic->value);
  } else {
    thisAgent->outputManager->printa_sf(
        thisAgent,
...
Symbol* int_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'int' function called with no arguments.\n");
    return NIL;
  }

  if (args->rest) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'int' takes exactly 1 argument.\n");
    return NIL;
  }
  ...
  if (sym->symbol_type == VARIABLE_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: variable (%y) passed to 'int' RHS function.\n", sym);
    return NIL;
  } else if (sym->symbol_type == IDENTIFIER_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: identifier (%y) passed to 'int' RHS function.\n",
        sym);
    return NIL;
    ...
    if (errno) {
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: bad integer (%y) given to 'int' RHS function\n",
          sym);
      return NIL;
    }
...
Symbol* float_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'float' function called with no arguments.\n");
    return NIL;
  }

  if (args->rest) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'float' takes exactly 1 argument.\n");
    return NIL;
  }
  ...
  if (sym->symbol_type == VARIABLE_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: variable (%y) passed to 'float' RHS function.\n",
        sym);
    return NIL;
  } else if (sym->symbol_type == IDENTIFIER_SYMBOL_TYPE) {
    thisAgent->outputManager->printa_sf(
        thisAgent, "Error: identifier (%y) passed to 'float' RHS function.\n",
        sym);
    return NIL;
  } else if (sym->symbol_type == STR_CONSTANT_SYMBOL_TYPE) {
    double float_val;
    ...
    if (errno) {
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: bad float (%y) given to 'float' RHS function\n",
          sym);
      return NIL;
    }
    ...
    return thisAgent->symbolManager->make_float_constant(
        static_cast<double>(sym->ic->value));
  }
...
Symbol* round_off_heading_air_rhs_function_code(agent* thisAgent, cons* args,
                                                void* /*user_data*/) {
  Symbol* arg;
  double n = 0, f_m = 0;
  int64_t i_m = 0;
  ...
  if (float_found) {
    return thisAgent->symbolManager->make_float_constant(
        normalize_heading_float(round_off_heading_float(n, f_m)));
  } else {
    return thisAgent->symbolManager->make_int_constant(normalize_heading_int(
        round_off_heading_int(static_cast<int64_t>(n), i_m)));
  }
}
...
Symbol* round_off_air_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (!args) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'round_off' function called with no arguments\n");
    return NIL;
  }
...
int64_t air_soar_round_off_angle(int64_t n, int64_t m) {
  ...
  // FIXME replace this code with the much faster mod2pi in ed olson's linalg
  // library
...
double bracket_rad_to_deg(double var) {
  return static_cast<double>(
      air_soar_round_off_angle(static_cast<int64_t>(RAD_TO_DEG(var)), 1));
}

int64_t convert(double flo) { return static_cast<int64_t>(flo); }

int64_t heading_to_point(int64_t current_x, int64_t current_y, int64_t x,
                         int64_t y) {
...
Symbol* compute_heading_rhs_function_code(agent* thisAgent, cons* args,
  ...
  for (c = args; c != NIL; c = c->rest) {
    ...
    if ((arg->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
        (arg->symbol_type != FLOAT_CONSTANT_SYMBOL_TYPE)) {
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: non-number (%y) passed to - compute-heading\n",
          arg);
      return NIL;
    }
  }
  ...
  if (count != 4) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'compute-heading' takes exactly 4 arguments.\n");
    return NIL;
  }

  arg = static_cast<Symbol*>(args->first);
  current_x = (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                  ? arg->ic->value
                  : static_cast<int64_t>(arg->fc->value);

  arg = static_cast<Symbol*>(args->rest->first);
  current_y = (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                  ? arg->ic->value
                  : static_cast<int64_t>(arg->fc->value);

  arg = static_cast<Symbol*>(args->rest->rest->first);
  waypoint_x = (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                   ? arg->ic->value
                   : static_cast<int64_t>(arg->fc->value);

  arg = static_cast<Symbol*>(args->rest->rest->rest->first);
  waypoint_y = (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                   ? arg->ic->value
                   : static_cast<int64_t>(arg->fc->value);
...
Symbol* compute_range_rhs_function_code(agent* thisAgent, cons* args,
  ...
  for (c = args; c != NIL; c = c->rest) {
    ...
    if ((arg->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
        (arg->symbol_type != FLOAT_CONSTANT_SYMBOL_TYPE)) {
      thisAgent->outputManager->printa_sf(
          thisAgent, "Error: non-number (%y) passed to - compute-range\n", arg);
      return NIL;
    }
  }
  ...
  if (count != 4) {
    thisAgent->outputManager->printa(
        thisAgent, "Error: 'compute-range' takes exactly 4 arguments.\n");
    return NIL;
  }

  arg = static_cast<Symbol*>(args->first);
  current_x = (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                  ? static_cast<double>(arg->ic->value)
                  : arg->fc->value;
  ...
  return thisAgent->symbolManager->make_int_constant(static_cast<int64_t>(
      sqrt((current_x - waypoint_x) * (current_x - waypoint_x) +
  ...
  if (args) {
    ...
    if (arg) {
      if (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE) {
        ...
        thisAgent->outputManager->printa_sf(
            thisAgent, "Error: non-number (%y) passed to - rand-float\n", arg);
        return NIL;
      }
    } else {
...
Symbol* rand_int_rhs_function_code(agent* thisAgent, cons* args,
  ...
  if (args) {
    ...
    if (arg) {
      if (arg->symbol_type == INT_CONSTANT_SYMBOL_TYPE) {
        ...
        thisAgent->outputManager->printa_sf(
            thisAgent, "Error: non-number (%y) passed to - rand-int\n", arg);
        return NIL;
      }
    } else {
      // assume default behavior (no arg)
  ...
  if (n > 0) {
    return thisAgent->symbolManager->make_int_constant(
        static_cast<int64_t>(SoarRandInt(static_cast<uint32_t>(n))));
  }
...
double _dice_prob_exact(int64_t dice, int64_t sides, int64_t count) {
  ...
  double p2nkn =
      pow(static_cast<double>(sides - 1), static_cast<double>(dice - count));
  double p2nkd =
      pow(static_cast<double>(sides), static_cast<double>(dice - count));
...
Symbol* dice_prob_rhs_function_code(agent* thisAgent, cons* args,
                                    void* /*user_data*/) {
  int64_t dice;
  int64_t sides;
  int64_t count;
  ...
  // parse + validate
  {
    ...
    if ((temp_sym->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
      ...
      thisAgent->outputManager->printa_sf(
          thisAgent,
          "Error: non-number (%y) passed as 'dice' to - "
          "compute-dice-probability\n",
          temp_sym);
      return NIL;
    }
    dice = ((temp_sym->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                ? (temp_sym->ic->value)
                : (static_cast<int64_t>(temp_sym->fc->value)));
    ...
    if ((temp_sym->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
      ...
      thisAgent->outputManager->printa_sf(
          thisAgent,
          "Error: non-number (%y) passed as 'sides' to - "
          "compute-dice-probability\n",
          temp_sym);
      return NIL;
    }
    sides = ((temp_sym->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                 ? (temp_sym->ic->value)
                 : (static_cast<int64_t>(temp_sym->fc->value)));
    ...
    if ((temp_sym->symbol_type != INT_CONSTANT_SYMBOL_TYPE) &&
      ...
      thisAgent->outputManager->printa_sf(
          thisAgent,
          "Error: non-number (%y) passed as 'count' to - "
          "compute-dice-probability\n",
          temp_sym);
      return NIL;
    }
    count = ((temp_sym->symbol_type == INT_CONSTANT_SYMBOL_TYPE)
                 ? (temp_sym->ic->value)
                 : (static_cast<int64_t>(temp_sym->fc->value)));
    ...
    if (temp_sym->symbol_type != STR_CONSTANT_SYMBOL_TYPE) {
      thisAgent->outputManager->printa_sf(
          thisAgent,
          "Error: non-string (%y) passed as 'pred' to - "
          "compute-dice-probability\n",
          temp_sym);
      return NIL;
    }
    ...
    if (pred == bad) {
      thisAgent->outputManager->printa_sf(
          thisAgent,
          "Error: invalid string (%y) passed as 'pred' to - "
          "compute-dice-probability\n",
          temp_sym);
      return NIL;
    }
  ...
  if (pred == eq) {
    ...
    if (count < 0) {
      ...
      ret = _dice_zero_tolerance(_dice_prob_atleast(dice, sides, count) -
                                 _dice_prob_exact(dice, sides, count));
    }
  } else if (pred == le) {
    if (count < 0) {
      ret = 0;
 ...
 */
[[nodiscard]] Symbol* set_reduce(agent* thisAgent, cons* args,
                                 Symbol* (*fn)(agent*, wme*, void*),
                                 void* data) {
  cons* c = args;
  ...
  if (param_set_id_sym != NIL && param_set_id_sym->is_sti()) {
    ...
    if (c != NIL) {
      ...
      if (param_attr_name_sym == NIL) {
        return thisAgent->symbolManager->make_str_constant(
            "|ERROR: Missing set attribute parameter.|");
      }
      ...
      if (c != NIL) {
        ...
        c = c->rest;
        if (c != NIL) param_level_3 = static_cast<symbol_struct*>(c->first);
      }

      for (wme* cwme = get_wmes_for_named_slot(set_id, param_attr_name_sym);
           cwme != NIL; cwme = cwme->next) {
        // The following if statement handles nested values inside of a
        // structure up to two levels. It can handle multi-valued attributes at
        // all levels
        if (!param_level_2) {
          ...
          for (wme* cwme2 = get_wmes_for_named_slot(cwme->value, param_level_2);
               cwme2 != NIL; cwme2 = cwme2->next) {
            if (!param_level_3) {
              ...
              for (wme* cwme3 =
                       get_wmes_for_named_slot(cwme2->value, param_level_3);
                   cwme3 != NIL; cwme3 = cwme3->next) {
    ...
    return thisAgent->symbolManager->make_str_constant(
        "|ERROR: First parameter needs to be an identifier.|");
  }
 ...
 * multi-valued attribute you want counted (second parameter).
 *
 * Returns an error string if there is an issue with the parameters, otherwise
 * the number of WMEs in the set.
 */
Symbol* set_count_rhs_function_code(agent* thisAgent, cons* args,
                                    void* /*user_data*/) {
 ...
 *
 * Pass the soar id of the set (first parameter) and the name of the
 * multi-valued attribute you want summed (second parameter).
 *
 * Non-numeric attributes are ignored.
 *
 * Non-numeric attributes are ignored; returns "NaN" if no numeric values are
 * found, or an error string if there is an issue with the parameters.
 */
Symbol* set_sum_rhs_function_code(agent* thisAgent, cons* args,
                                  void* /*user_data*/) {
  struct wme_val_stats stats;
 ...
 *
 * Pass the soar id of the set (first parameter) and the name of the
 * multi-valued attribute you want multiplied (second parameter).
 *
 * Non-numeric attributes are ignored.
 *
 * Non-numeric attributes are ignored; returns "NaN" if no numeric values are
 * found, or an error string if there is an issue with the parameters.
 */
Symbol* set_multiply_rhs_function_code(agent* thisAgent, cons* args,
                                       void* /*user_data*/) {
  struct wme_val_stats stats;
 ...
 *
 * Pass the soar id of the set (first parameter) and the name of the
 * multi-valued attribute you want min of (second parameter).
 *
 * Non-numeric attributes are ignored; returns "NaN" if no numeric values are
 * found, or an error string if there is an issue with the parameters.
 */
Symbol* set_min_rhs_function_code(agent* thisAgent, cons* args,
                                  void* /*user_data*/) {
  struct wme_val_stats stats;
 ...
 *
 * Pass the soar id of the set (first parameter) and the name of the
 * multi-valued attribute you want max of (second parameter).
 *
 * Non-numeric attributes are ignored; returns "NaN" if no numeric values are
 * found, or an error string if there is an issue with the parameters.
 */
Symbol* set_max_rhs_function_code(agent* thisAgent, cons* args,
                                  void* /*user_data*/) {
  struct wme_val_stats stats;
  Symbol* error = set_reduce(thisAgent, args, min_max_wme, &stats);
 ...
 *
 * Pass the soar id of the set (first parameter) and the name of the
 * multi-valued attribute you want range of (second parameter).
 *
 * Non-numeric attributes are ignored; returns "NaN" if no numeric values are
 * found, or an error string if there is an issue with the parameters.
 */
Symbol* set_range_rhs_function_code(agent* thisAgent, cons* args,
                                    void* /*user_data*/) {
  struct wme_val_stats stats;
  Symbol* error = set_reduce(thisAgent, args, min_max_wme, &stats);
  ...
  return (stats.count > 0) ? thisAgent->symbolManager->make_float_constant(
                                 stats.max - stats.min)
                           : thisAgent->symbolManager->make_str_constant("NaN");
}
 ...
 *
 * Pass the soar id of the set (first parameter) and the name of the
 * multi-valued attribute you want the mean of (second parameter).
 *
 * Non-numeric attributes are ignored; returns "NaN" if no numeric values are
 * found, or an error string if there is an issue with the parameters.
 */
Symbol* set_mean_rhs_function_code(agent* thisAgent, cons* args,
                                   void* /*user_data*/) {
  struct wme_val_stats stats;
 ...
 *
 * Pass the soar id of the set (first parameter) and the name of the
 * multi-valued attribute you want the standard deviation of (second parameter).
 *
 * Non-numeric attributes are ignored; returns "NaN" if no numeric values are
 * found, or an error string if there is an issue with the parameters.
 */
Symbol* set_stdev_rhs_function_code(agent* thisAgent, cons* args,
                                    void* /*user_data*/) {
  struct wme_val_stats stats;
  Symbol* error = set_reduce(thisAgent, args, mean_wme, &stats);
  ...
  if (stats.count > 0) {
    ...
    return (error == NIL) ? thisAgent->symbolManager->make_float_constant(
                                sqrt(stats.sum_square / (double)stats.count))
                          : error;
  } else {
    return thisAgent->symbolManager->make_str_constant("NaN");
  }
...
void init_built_in_rhs_math_functions(agent* thisAgent) {
  ...
  add_rhs_function(thisAgent, thisAgent->symbolManager->make_str_constant("+"),
                   plus_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent, thisAgent->symbolManager->make_str_constant("*"),
                   times_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent, thisAgent->symbolManager->make_str_constant("-"),
                   minus_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent, thisAgent->symbolManager->make_str_constant("/"),
                   fp_divide_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("div"),
                   div_rhs_function_code, 2, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("size"),
                   size_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("sum"),
                   sum_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("product"),
                   product_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("mod"),
                   mod_rhs_function_code, 2, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("min"),
                   min_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("max"),
                   max_rhs_function_code, -1, true, false, 0, true);

  /* RHS set functions */
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-count"),
                   set_count_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-sum"),
                   set_sum_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-multiply"),
                   set_multiply_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-min"),
                   set_min_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-max"),
                   set_max_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-range"),
                   set_range_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-mean"),
                   set_mean_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("set-stdev"),
                   set_stdev_rhs_function_code, -1, true, false, 0, true);

  /* RHS trigonometry functions */
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("sin"),
                   sin_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("cos"),
                   cos_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("atan2"),
                   atan2_rhs_function_code, 2, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("sqrt"),
                   sqrt_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("abs"),
                   abs_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("int"),
                   int_rhs_function_code, 1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("float"),
                   float_rhs_function_code, 1, true, false, 0, true);

  /* RHS special purpose functions for computing headings and range */
  add_rhs_function(
      thisAgent,
      thisAgent->symbolManager->make_str_constant("round-off-heading"),
      round_off_heading_air_rhs_function_code, 2, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("round-off"),
                   round_off_air_rhs_function_code, 2, true, false, 0, true);
  add_rhs_function(
      thisAgent, thisAgent->symbolManager->make_str_constant("compute-heading"),
      compute_heading_rhs_function_code, 4, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("compute-range"),
                   compute_range_rhs_function_code, 4, true, false, 0, true);

  /* RHS special purpose functions for Michigan Dice app*/
  add_rhs_function(
      thisAgent,
      thisAgent->symbolManager->make_str_constant("compute-dice-probability"),
      dice_prob_rhs_function_code, 4, true, false, 0, true);

  /* RHS functions that generate random numbers */
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("rand-int"),
                   rand_int_rhs_function_code, -1, true, false, 0, true);
  add_rhs_function(thisAgent,
                   thisAgent->symbolManager->make_str_constant("rand-float"),
                   rand_float_rhs_function_code, -1, true, false, 0, true);
}

void remove_built_in_rhs_math_functions(agent* thisAgent) {
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("+"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("*"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("-"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("/"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("div"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("size"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("sum"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("product"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("mod"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("min"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("max"));

  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("set-count"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("set-sum"));
  remove_rhs_function(
      thisAgent, thisAgent->symbolManager->find_str_constant("set-multiply"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("set-min"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("set-max"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("set-range"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("set-mean"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("set-stdev"));

  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("sin"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("cos"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("atan2"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("sqrt"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("abs"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("int"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("float"));

  remove_rhs_function(thisAgent, thisAgent->symbolManager->find_str_constant(
                                     "round-off-heading"));
  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("round-off"));
  remove_rhs_function(thisAgent, thisAgent->symbolManager->find_str_constant(
                                     "compute-heading"));
  remove_rhs_function(
      thisAgent, thisAgent->symbolManager->find_str_constant("compute-range"));
  remove_rhs_function(thisAgent, thisAgent->symbolManager->find_str_constant(
                                     "compute-dice-probability"));

  remove_rhs_function(thisAgent,
                      thisAgent->symbolManager->find_str_constant("rand-int"));
  remove_rhs_function(
      thisAgent, thisAgent->symbolManager->find_str_constant("rand-float"));
}
