...
test copy_test(agent* thisAgent, test t, bool pUseUnifiedIdentitySet = false,
               bool pStripLiteralConjuncts = false,
               bool remove_state_impasse = false, bool* removed_goal = NULL,
               bool* removed_impasse = NULL);

bool add_test(agent* thisAgent, test* dest_address, test new_test,
              bool merge_disjunctions = false);
void add_test_if_not_already_there(agent* thisAgent, test* t, test new_test,
                                   bool neg, bool merge_disjunctions = false);
...
void add_identity_to_original_id_test(agent* thisAgent, condition* cond,
                                      byte field_num,
                                      rete_node_level levels_up);
void add_rete_test_list_to_tests(agent* thisAgent, condition* cond,
                                 rete_test* rt);
