...
extern ProdReorderFailureType reorder_action_list(
    agent* thisAgent, action** action_list, tc_number lhs_tc,
    matched_symbol_list* ungrounded_syms, bool add_ungrounded = false);
extern ProdReorderFailureType reorder_lhs(
