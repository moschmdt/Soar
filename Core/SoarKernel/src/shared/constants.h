...
#define USER_SELECT_E_GREEDY \
  2 /* with probability epsilon choose random, otherwise greedy */
...
#define USER_SELECT_SOFTMAX \
  6 /* pick one at random, probabalistically biased by numeric preferences */
...
#define TRACE_FIRINGS_OF_USER_PRODS_SYSPARAM \
  3  // 1 Warning: these next four MUST be
#define TRACE_FIRINGS_OF_DEFAULT_PRODS_SYSPARAM \
  4  // 2  consecutive and in the order of
#define TRACE_FIRINGS_OF_CHUNKS_SYSPARAM 5  // 3  the production types defined
#define TRACE_FIRINGS_OF_JUSTIFICATIONS_SYSPARAM \
  6                                            // 4  in the enum ProductionType
