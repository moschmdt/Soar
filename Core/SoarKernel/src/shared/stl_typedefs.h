...
typedef std::list<action_record*,
                  soar_module::soar_memory_pool_allocator<action_record*> >
    action_record_list;
typedef std::list<condition*,
                  soar_module::soar_memory_pool_allocator<condition*> >
    condition_list;
typedef std::list<condition_record*,
                  soar_module::soar_memory_pool_allocator<condition_record*> >
    condition_record_list;
typedef std::list<constraint*,
                  soar_module::soar_memory_pool_allocator<constraint*> >
    constraint_list;
typedef std::list<Identity*,
                  soar_module::soar_memory_pool_allocator<Identity*> >
    identity_list;
typedef std::list<identity_mapping*,
                  soar_module::soar_memory_pool_allocator<identity_mapping*> >
    identity_mapping_list;
typedef std::list<instantiation*,
                  soar_module::soar_memory_pool_allocator<instantiation*> >
    inst_list;
typedef std::list<
    instantiation_record*,
    soar_module::soar_memory_pool_allocator<instantiation_record*> >
    inst_record_list;
typedef std::list<chunk_element*,
                  soar_module::soar_memory_pool_allocator<chunk_element*> >
    matched_symbol_list;
typedef std::list<preference*,
                  soar_module::soar_memory_pool_allocator<preference*> >
    preference_list;
typedef std::list<Repair_Path*,
                  soar_module::soar_memory_pool_allocator<Repair_Path*> >
    repair_path_list;
typedef std::list<production*,
                  soar_module::soar_memory_pool_allocator<production*> >
    production_list;
typedef std::list<rhs_value,
                  soar_module::soar_memory_pool_allocator<rhs_value> >
    rhs_value_list;
typedef std::list<Symbol*, soar_module::soar_memory_pool_allocator<Symbol*> >
    symbol_list;
typedef std::list<symbol_triple*,
                  soar_module::soar_memory_pool_allocator<symbol_triple*> >
    symbol_triple_list;
typedef std::list<deep_copy_wme*,
                  soar_module::soar_memory_pool_allocator<deep_copy_wme*> >
    deep_copy_wme_list;
typedef std::list<wme*, soar_module::soar_memory_pool_allocator<wme*> >
    wme_list;
...
typedef std::set<instantiation*, std::less<instantiation*>,
    ...
    inst_set;
typedef std::set<
    instantiation_record*, std::less<instantiation_record*>,
    soar_module::soar_memory_pool_allocator<instantiation_record*> >
    inst_record_set;
typedef std::set<production_record*, std::less<production_record*>,
                 soar_module::soar_memory_pool_allocator<production_record*> >
    production_record_set;
typedef std::set<Symbol*, std::less<Symbol*>,
                 soar_module::soar_memory_pool_allocator<Symbol*> >
    symbol_set;
...
typedef std::set<wma_d_cycle, std::less<wma_d_cycle>,
                 soar_module::soar_memory_pool_allocator<wma_d_cycle> >
    wma_decay_cycle_set;
typedef std::set<wme*, std::less<wme*>,
...
typedef std::unordered_map<uint64_t, identity_mapping_list*>
    inst_identities_map;
...
typedef std::unordered_map<uint64_t, instantiation_record*>
    instantiation_record_map;
 ...
 * unordered_set, vector and unordered_map  */

typedef std::set<augmentation*, std::less<augmentation*>,
                 soar_module::soar_memory_pool_allocator<augmentation*> >
    augmentation_set;
typedef std::set<uint64_t, std::less<uint64_t>,
                 soar_module::soar_memory_pool_allocator<uint64_t> >
    id_set;
typedef std::set<ltm_object*, std::less<ltm_object*>,
                 soar_module::soar_memory_pool_allocator<ltm_object*> >
    ltm_set;

typedef std::list<ltm_value*,
                  soar_module::soar_memory_pool_allocator<ltm_value*> >
    ltm_slot;
typedef std::list<
    smem_weighted_cue_element*,
    soar_module::soar_memory_pool_allocator<smem_weighted_cue_element*> >
    smem_weighted_cue_list;

typedef std::map<uint64_t, uint64_t, std::less<uint64_t>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<uint64_t const, uint64_t> > >
    id_to_id_map;
typedef std::map<uint64_t, Symbol*, std::less<uint64_t>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<uint64_t const, Symbol*> > >
    id_to_sym_map;
typedef std::map<uint64_t, Identity*, std::less<uint64_t>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<uint64_t const, Identity*> > >
    id_to_join_map;
typedef std::map<uint64_t, std::string, std::less<uint64_t>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<uint64_t const, std::string> > >
    id_to_string_map;
typedef std::map<uint64_t, identity_mapping_list*, std::less<uint64_t>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<uint64_t const, identity_mapping_list*> > >
    inst_identities_map;
typedef std::map<rhs_value, std::string, std::less<rhs_value>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<rhs_value const, std::string> > >
    rhs_val_to_string_map;
typedef std::map<Symbol*, augmentation_set*, std::less<Symbol*>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<Symbol* const, augmentation_set*> > >
    sym_to_aug_map;
typedef std::map<Symbol*, condition*, std::less<Symbol*>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<Symbol* const, condition*> > >
    sym_to_cond_map;
typedef std::map<Symbol*, uint64_t, std::less<Symbol*>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<Symbol* const, uint64_t> > >
