...
typedef struct symbol_triple_struct {
  ...
  symbol_triple_struct(Symbol* new_id = NULL, Symbol* new_attr = NULL,
...
typedef struct test_triple_struct {
  ...
  test_triple_struct(test new_id = NULL, test new_attr = NULL,
                     test new_value = NULL)
      : id(new_id), attr(new_attr), value(new_value) {}
} test_triple;
...
typedef struct identity_quadruple_struct {
  ...
  identity_quadruple_struct(uint64_t new_id = 0, uint64_t new_attr = 0,
                            uint64_t new_value = 0, uint64_t new_referent = 0)
      : id(new_id), attr(new_attr), value(new_value), referent(new_referent) {}
} identity_quadruple;
...
typedef struct identity_set_quadruple_struct {
  ...
  //        identity_set_quadruple_struct(IdentitySet* new_id, IdentitySet*
  //        new_attr, IdentitySet* new_value, IdentitySet* new_referent):
  //        id(new_id), attr(new_attr), value(new_value), referent(new_referent)
  //        {}
...
typedef struct bool_quadruple_struct {
  ...
  bool_quadruple_struct(uint64_t new_id = false, uint64_t new_attr = false,
                        uint64_t new_value = false,
                        uint64_t new_referent = false)
      : id(new_id), attr(new_attr), value(new_value), referent(new_referent) {}
} bool_quadruple;
...
typedef struct rhs_quadruple_struct {
  ...
  rhs_quadruple_struct(rhs_value new_id = NULL, rhs_value new_attr = NULL,
                       rhs_value new_value = NULL,
                       rhs_value new_referent = NULL)
      : id(new_id), attr(new_attr), value(new_value), referent(new_referent) {}
} rhs_quadruple;
...
typedef struct deep_copy_struct {
  ...
  Symbol* value;
  wme* deep_copied_wme;
  deep_copy_struct(Symbol* new_id = NULL, Symbol* new_attr = NULL,
                   Symbol* new_value = NULL, wme* new_wme = NULL)
      : id(new_id),
        attr(new_attr),
        value(new_value),
        deep_copied_wme(new_wme) {}
} deep_copy_wme;
...
typedef struct constraint_struct {
  ...
  constraint_struct(test new_eq, test new_constraint)
