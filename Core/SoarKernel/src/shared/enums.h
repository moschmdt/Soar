...
enum ebc_rule_type { ebc_no_rule, ebc_chunk, ebc_justification, ebc_template };
...
enum BTSourceType { BT_BaseInstantiation, BT_OSK, BT_ExtraResults, BT_Normal };

enum visMemoryFormat { viz_node, viz_record };

enum visRuleFormat { viz_name, viz_full };
...
enum EBCTraceType { ebc_actual_trace, ebc_match_trace, ebc_explanation_trace };
...
enum chunkNameFormats { numberedFormat, ruleFormat };

enum MessageType { debug_msg, trace_msg, refcnt_msg };
...
enum ExplainTraceType { WM_Trace, Explanation_Trace, WM_Trace_w_Inequalities };
