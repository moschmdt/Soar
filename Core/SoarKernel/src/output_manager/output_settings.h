...
class OM_Parameters : public soar_module::param_container {
 public:
  ...
  void update_bool_setting(agent* thisAgent,
                           soar_module::boolean_param* pChangedParam,
                           sml::KernelSML* pKernelSML);
  void update_int_setting(agent* thisAgent,
                          soar_module::integer_param* pChangedParam);
