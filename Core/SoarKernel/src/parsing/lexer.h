...
class Lexer {
 public:
   ...
   * use arbitrary RHS functions defined in their language of choice. The
   * implementation here is hacky, but necessary to match the behavior of JSoar.
   */
  void addExec();
 ...
 private:
   ...
   *
   * TODO: perhaps this return value can eliminate some calls to
