...
class epmem_path_param : public soar_module::string_param {
 ...
 public:
  epmem_path_param(const char* new_name, const char* new_value,
...
class epmem_db_lib_version_stat
    : public soar_module::primitive_stat<const char*> {
 protected:
  agent* thisAgent;

 public:
  epmem_db_lib_version_stat(agent* new_agent, const char* new_name,
...
class epmem_mem_usage_stat : public soar_module::integer_stat {
 ...
 public:
  epmem_mem_usage_stat(agent* new_agent, const char* new_name,
                       int64_t new_value,
...
class epmem_mem_high_stat : public soar_module::integer_stat {
 ...
 public:
  epmem_mem_high_stat(agent* new_agent, const char* new_name, int64_t new_value,
                      soar_module::predicate<int64_t>* new_prot_pred);
  int64_t get_value();
};
...
typedef std::map<epmem_node_id, bool, std::less<epmem_node_id>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<epmem_node_id const, bool> > >
    epmem_id_removal_map;
typedef std::map<std::pair<epmem_node_id const, int64_t>, bool,
                 std::less<std::pair<epmem_node_id const, int64_t> >,
                 soar_module::soar_memory_pool_allocator<std::pair<
                     std::pair<epmem_node_id const, int64_t> const, bool> > >
    epmem_edge_removal_map;
...
extern bool epmem_backup_db(agent* thisAgent, const char* file_name,
                            std::string* err);
extern void epmem_init_db(agent* thisAgent, bool readonly = false);
// visualization
extern void epmem_visualize_episode(agent* thisAgent, epmem_time_id memory_id,
                                    std::string* buf);
extern void epmem_print_episode(agent* thisAgent, epmem_time_id memory_id,
                                std::string* buf);
...
typedef std::map<epmem_symbol_literal_pair, int>
...
#ifdef USE_MEM_POOL_ALLOCATORS
typedef std::map<epmem_triple, epmem_uedge*, std::less<epmem_triple>,
                 soar_module::soar_memory_pool_allocator<
                     std::pair<epmem_triple const, epmem_uedge*> > >
    epmem_triple_uedge_map;
typedef std::set<epmem_interval*, std::less<epmem_interval*>,
                 soar_module::soar_memory_pool_allocator<epmem_interval*> >
    epmem_interval_set;
typedef std::set<epmem_node_id, std::less<epmem_node_id>,
                 soar_module::soar_memory_pool_allocator<epmem_node_id> >
    epmem_node_set;
typedef std::set<epmem_node_pair, std::less<epmem_node_pair>,
...
typedef std::priority_queue<epmem_pedge*, std::vector<epmem_pedge*>,
...
typedef std::priority_queue<epmem_interval*, std::vector<epmem_interval*>,
