...
class GraphViz_Visualizer {
 public:
  ...
  void viz_object_start(Symbol* pName, uint64_t node_id,
                        ...
                        std::string* pMakeUnique = NULL);
  void viz_object_start_string(std::string& pName, uint64_t node_id,
                               visObjectType objectType,
                               std::string* pMakeUnique = NULL);
  ...
  void viz_table_element_start(uint64_t pNodeID = 0, char pTypeChar = ' ',
                               WME_Field pField = NO_ELEMENT,
                               bool pRowBorder = false,
                               const char* pModStr = " ");
  void viz_table_element_end();
  void viz_table_element_conj_start(uint64_t pNodeID = 0, char pTypeChar = ' ',
                                    WME_Field pField = NO_ELEMENT,
                                    bool pRowBorder = false,
                                    const char* pModStr = " ");
  ...
  void viz_connect_action_to_cond(uint64_t pSrcRuleID, uint64_t pSrcActionID,
